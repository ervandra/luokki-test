          ...
          <div className="col">
            <div className="content">
                ...
                <div className="row">
                  <div className="col-12  ml-auto mr-auto mb-5">
                    <div className="multisteps-form__progress">
                      ...
                      <button className="multisteps-form__progress-btn js-active" type="button" title={t('confirmation_header_label')}>{t('confirmation_header_label')}</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="quotation-status py-5">
                ...
                <h6 className="text-secondary text-center">Your order has been confirmed and completed</h6>
              </div>

              <Link to="/"><button className="btn mb-5 w-100 btn-outline-primary">Explore more services</button></Link>
